...
public class HandleRequest {
     ...
     */
    public static RequestSpecification configureRequest() throws UnsupportedEncodingException, CloneNotSupportedException, NoSuchAlgorithmException {
        return given().spec(REQUEST);
    }

    public static Response get(RequestSpecification request, String endpoint) throws UnsupportedEncodingException, CloneNotSupportedException, NoSuchAlgorithmException {
        return request
                .when()
                .get(endpoint);
    }
